...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/09/2026 às 14:53
...
--
-- Estrutura stand-in para view `aluno_curso`
...
--
-- Estrutura stand-in para view `aluno_disciplina_notas`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `aluno_disciplina_notas`;
CREATE TABLE `aluno_disciplina_notas` (
...
--
-- Estrutura stand-in para view `aluno_responsavel`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `aluno_responsavel`;
...
--
-- Estrutura stand-in para view `aluno_turma_curso`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `aluno_turma_curso`;
CREATE TABLE `aluno_turma_curso` (
`id_alunos` int(11)
,`nome_aluno` varchar(100)
,`id_turmas` int(11)
...
--
-- Estrutura stand-in para view `aluno_turma_disciplina_professor`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `aluno_turma_disciplina_professor`;
CREATE TABLE `aluno_turma_disciplina_professor` (
`id_alunos` int(11)
,`nome_aluno` varchar(100)
,`id_turmas` int(11)
,`ano_letivo` varchar(10)
...
INSERT INTO `boletins` (`id_boletim`, `media_final`, `situacao`, `frequencia`, `id_disciplina`, `id_alunos`) VALUES
(1, 8.70, 'Aprovado', '96', 1, 1),
(2, 7.90, 'Aprovado', '91', 2, 2),
(3, 6.50, 'Recuperação', '78', 3, 3),
(4, 9.20, 'Aprovado', '99', 4, 4),
(5, 5.30, 'Reprovado', '68', 5, 5),
(6, 8.10, 'Aprovado', '94', 6, 6),
(7, 7.40, 'Aprovado', '89', 7, 7),
(8, 6.80, 'Recuperação', '82', 8, 8),
(9, 9.50, 'Aprovado', '100', 9, 9),
(10, 5.80, 'Reprovado', '70', 10, 10),
(11, 8.90, 'Aprovado', '97', 11, 11),
(12, 7.60, 'Aprovado', '90', 12, 12),
(13, 6.20, 'Recuperação', '80', 13, 13),
(14, 9.10, 'Aprovado', '98', 14, 14),
(15, 5.00, 'Reprovado', '65', 15, 15),
(16, 8.40, 'Aprovado', '95', 16, 16),
(17, 7.80, 'Aprovado', '92', 17, 17),
(18, 6.70, 'Recuperação', '81', 18, 18),
(19, 9.60, 'Aprovado', '100', 19, 19),
(20, 5.40, 'Reprovado', '69', 20, 20),
(21, 8.30, 'Aprovado', '94', 21, 21),
(22, 7.50, 'Aprovado', '88', 22, 22),
(23, 6.90, 'Recuperação', '83', 23, 23),
(24, 9.40, 'Aprovado', '99', 24, 24),
(25, 5.70, 'Reprovado', '71', 25, 25),
(26, 8.60, 'Aprovado', '96', 26, 26),
(27, 7.70, 'Aprovado', '91', 27, 27),
(28, 6.30, 'Recuperação', '79', 28, 28),
(29, 9.00, 'Aprovado', '97', 29, 29),
(30, 5.10, 'Reprovado', '67', 30, 30),
(31, 8.80, 'Aprovado', '95', 31, 31),
(32, 7.20, 'Aprovado', '87', 32, 32),
(33, 6.60, 'Recuperação', '82', 33, 33),
(34, 9.30, 'Aprovado', '98', 34, 34),
(35, 5.60, 'Reprovado', '70', 35, 35),
(36, 8.20, 'Aprovado', '93', 36, 36),
(37, 7.30, 'Aprovado', '89', 37, 37),
(38, 6.40, 'Recuperação', '80', 38, 38),
(39, 9.70, 'Aprovado', '100', 39, 39),
(40, 5.50, 'Reprovado', '68', 40, 40),
(41, 8.50, 'Aprovado', '94', 41, 41),
(42, 7.10, 'Aprovado', '86', 42, 42),
(43, 6.10, 'Recuperação', '78', 43, 43),
(44, 9.80, 'Aprovado', '100', 44, 44),
(45, 5.20, 'Reprovado', '66', 45, 45),
(46, 8.00, 'Aprovado', '92', 46, 46),
(47, 7.00, 'Aprovado', '85', 47, 47),
(48, 6.00, 'Recuperação', '77', 48, 48),
(49, 9.90, 'Aprovado', '100', 49, 49),
(50, 5.90, 'Reprovado', '72', 50, 50);
...
--
-- Estrutura stand-in para view `desempenho_academico`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `desempenho_academico`;
...
--
-- Estrutura stand-in para view `disciplina_curso_professor`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `disciplina_curso_professor`;
CREATE TABLE `disciplina_curso_professor` (
`nome_do_curso` varchar(100)
,`nome_disciplina` varchar(100)
...
--
-- Estrutura stand-in para view `disciplina_professor`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `disciplina_professor`;
...
--
-- Estrutura stand-in para view `situacao_matricula`
-- (Veja abaixo para a visão atual)
--
DROP VIEW IF EXISTS `situacao_matricula`;
...
--
-- Estrutura para view `aluno_curso`
--
DROP TABLE IF EXISTS `aluno_curso`;

DROP VIEW IF EXISTS `aluno_curso`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `aluno_curso`  AS SELECT `tab1`.`id_alunos` AS `id_alunos`, `tab1`.`nome` AS `nome`, `tab1`.`cpf` AS `cpf`, `tab2`.`id_matricula` AS `id_matricula`, `tab2`.`situacao_da_matricula` AS `situacao_da_matricula`, `tab3`.`id_curso` AS `id_curso`, `tab3`.`nome_do_curso` AS `nome_do_curso` FROM ((`alunos` `tab1` join `matricula` `tab2` on(`tab1`.`id_alunos` = `tab2`.`id_alunos`)) join `cursos` `tab3` on(`tab1`.`id_curso` = `tab3`.`id_curso`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `aluno_disciplina_notas`
--
DROP TABLE IF EXISTS `aluno_disciplina_notas`;

DROP VIEW IF EXISTS `aluno_disciplina_notas`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `aluno_disciplina_notas`  AS SELECT `a`.`nome` AS `nome_aluno`, `d`.`nome_disciplina` AS `nome_disciplina`, `b`.`media_final` AS `media_final`, `b`.`situacao` AS `situacao_final` FROM ((`boletins` `b` join `alunos` `a` on(`b`.`id_alunos` = `a`.`id_alunos`)) join `disciplinas` `d` on(`b`.`id_disciplina` = `d`.`id_disciplinas`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `aluno_responsavel`
--
DROP TABLE IF EXISTS `aluno_responsavel`;

DROP VIEW IF EXISTS `aluno_responsavel`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `aluno_responsavel`  AS SELECT `a`.`nome` AS `nome_aluno`, `a`.`cpf` AS `cpf_aluno`, `r`.`nome` AS `nome_responsavel`, `r`.`cpf` AS `cpf_responsavel`, `t`.`numero_tel` AS `telefone_responsavel`, `r`.`parentesco` AS `parentesco` FROM (((`alunos` `a` join `alunos_responsaveis` `ar` on(`a`.`id_alunos` = `ar`.`id_alunos`)) join `responsaveis` `r` on(`ar`.`id_responsaveis` = `r`.`id_responsaveis`)) left join `telefones` `t` on(`r`.`id_dados` = `t`.`id_dados`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `aluno_turma_curso`
--
DROP TABLE IF EXISTS `aluno_turma_curso`;

DROP VIEW IF EXISTS `aluno_turma_curso`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `aluno_turma_curso`  AS SELECT `tab1`.`id_alunos` AS `id_alunos`, `tab1`.`nome` AS `nome_aluno`, `tab3`.`id_turmas` AS `id_turmas`, `tab3`.`ano_letivo` AS `ano_letivo`, `tab3`.`turno` AS `turno`, `tab3`.`sala` AS `sala`, `tab4`.`id_curso` AS `id_curso`, `tab4`.`nome_do_curso` AS `nome_do_curso` FROM (((`alunos` `tab1` join `matricula` `tab2` on(`tab1`.`id_alunos` = `tab2`.`id_alunos`)) join `turmas` `tab3` on(`tab2`.`id_turmas` = `tab3`.`id_turmas`)) join `cursos` `tab4` on(`tab3`.`id_cursos` = `tab4`.`id_curso`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `aluno_turma_disciplina_professor`
--
DROP TABLE IF EXISTS `aluno_turma_disciplina_professor`;

DROP VIEW IF EXISTS `aluno_turma_disciplina_professor`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `aluno_turma_disciplina_professor`  AS SELECT `al`.`id_alunos` AS `id_alunos`, `al`.`nome` AS `nome_aluno`, `tu`.`id_turmas` AS `id_turmas`, `tu`.`ano_letivo` AS `ano_letivo`, `tu`.`turno` AS `turno`, `c`.`id_curso` AS `id_curso`, `c`.`nome_do_curso` AS `nome_do_curso`, `d`.`id_disciplinas` AS `id_disciplinas`, `d`.`nome_disciplina` AS `nome_disciplina`, `p`.`id_professores` AS `id_professores`, `p`.`nome` AS `nome_professor` FROM (((((`alunos` `al` join `matricula` `m` on(`al`.`id_alunos` = `m`.`id_alunos`)) join `turmas` `tu` on(`m`.`id_turmas` = `tu`.`id_turmas`)) join `cursos` `c` on(`al`.`id_curso` = `c`.`id_curso`)) join `disciplinas` `d` on(`d`.`id_cursos` = `c`.`id_curso`)) join `professores` `p` on(`d`.`id_professores` = `p`.`id_professores`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `desempenho_academico`
--
DROP TABLE IF EXISTS `desempenho_academico`;

DROP VIEW IF EXISTS `desempenho_academico`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `desempenho_academico`  AS SELECT `a`.`nome` AS `nome_aluno`, `c`.`nome_do_curso` AS `nome_do_curso`, `d`.`nome_disciplina` AS `nome_disciplina`, `b`.`media_final` AS `media_final`, `b`.`frequencia` AS `frequencia`, `b`.`situacao` AS `situacao_final` FROM (((`boletins` `b` join `alunos` `a` on(`b`.`id_alunos` = `a`.`id_alunos`)) join `disciplinas` `d` on(`b`.`id_disciplina` = `d`.`id_disciplinas`)) join `cursos` `c` on(`a`.`id_curso` = `c`.`id_curso`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `disciplina_curso_professor`
--
DROP TABLE IF EXISTS `disciplina_curso_professor`;

DROP VIEW IF EXISTS `disciplina_curso_professor`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `disciplina_curso_professor`  AS SELECT `c`.`nome_do_curso` AS `nome_do_curso`, `d`.`nome_disciplina` AS `nome_disciplina`, `d`.`carga_horaria` AS `carga_horaria`, `p`.`nome` AS `nome_professor` FROM ((`disciplinas` `d` join `cursos` `c` on(`d`.`id_cursos` = `c`.`id_curso`)) join `professores` `p` on(`d`.`id_professores` = `p`.`id_professores`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `disciplina_professor`
--
DROP TABLE IF EXISTS `disciplina_professor`;

DROP VIEW IF EXISTS `disciplina_professor`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `disciplina_professor`  AS SELECT `d`.`id_disciplinas` AS `id_disciplinas`, `d`.`nome_disciplina` AS `nome_disciplina`, `d`.`carga_horaria` AS `carga_horaria`, `p`.`id_professores` AS `id_professores`, `p`.`nome` AS `nome_professor`, `dp`.`formacao` AS `formacao` FROM ((`disciplinas` `d` join `professores` `p` on(`d`.`id_professores` = `p`.`id_professores`)) join `dados_pessoais` `dp` on(`p`.`id_dados` = `dp`.`id_dados`)) ;
...
DROP VIEW IF EXISTS `relatorio_academico_completo`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `relatorio_academico_completo`  AS SELECT `a`.`nome` AS `nome_aluno`, `c`.`nome_do_curso` AS `nome_do_curso`, `t`.`id_turmas` AS `id_turmas`, `t`.`ano_letivo` AS `ano_letivo`, `t`.`turno` AS `turno`, `d`.`nome_disciplina` AS `nome_disciplina`, `p`.`nome` AS `nome_professor`, `b`.`media_final` AS `media_final`, `b`.`frequencia` AS `frequencia`, `b`.`situacao` AS `situacao_final` FROM ((((((`boletins` `b` join `alunos` `a` on(`b`.`id_alunos` = `a`.`id_alunos`)) join `disciplinas` `d` on(`b`.`id_disciplina` = `d`.`id_disciplinas`)) join `cursos` `c` on(`a`.`id_curso` = `c`.`id_curso`)) join `professores` `p` on(`d`.`id_professores` = `p`.`id_professores`)) join `matricula` `m` on(`a`.`id_alunos` = `m`.`id_alunos`)) join `turmas` `t` on(`m`.`id_turmas` = `t`.`id_turmas`)) ;

-- --------------------------------------------------------

--
-- Estrutura para view `situacao_matricula`
--
DROP TABLE IF EXISTS `situacao_matricula`;

DROP VIEW IF EXISTS `situacao_matricula`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `situacao_matricula`  AS SELECT `al`.`id_alunos` AS `id_alunos`, `al`.`nome` AS `nome_aluno`, `c`.`id_curso` AS `id_curso`, `c`.`nome_do_curso` AS `nome_do_curso`, `tu`.`id_turmas` AS `id_turmas`, `tu`.`ano_letivo` AS `ano_letivo`, `tu`.`turno` AS `turno`, `m`.`data_matricula` AS `data_matricula`, `m`.`situacao_da_matricula` AS `situacao_da_matricula` FROM (((`alunos` `al` join `matricula` `m` on(`al`.`id_alunos` = `m`.`id_alunos`)) join `turmas` `tu` on(`m`.`id_turmas` = `tu`.`id_turmas`)) join `cursos` `c` on(`al`.`id_curso` = `c`.`id_curso`)) ;
...
ALTER TABLE `boletins`
  ...
  ADD KEY `fk_boletim_aluno` (`id_alunos`);
...
--
ALTER TABLE `boletins`
  ADD CONSTRAINT `fk_boletim_aluno` FOREIGN KEY (`id_alunos`) REFERENCES `alunos` (`id_alunos`);
